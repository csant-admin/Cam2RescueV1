                ...
                <div class="card-body p-md-5 text-black">
                    <div class="card-body">
                        ...
                        <form action="#" method="POST" name="login">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6">
                                        <input type="date" id="dob" class="form-control form-control-lg m-2" name="dob" onfocus="(this.type='Date')" required autofocus>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <button type="submit" name="submit" class="btn btn-primary form-control form-control-lg m-2 p-2">Register</button>
                                    </div>
                                </div>
                            </form>
                        </div>
